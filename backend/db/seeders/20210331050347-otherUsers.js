...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Users', [
      {username: "lilHans", email: "zimmerman@gmail.com", hashedPassword: bcrypt.hashSync("interstellar")},
      ...
      {username:"damnitJerry", email:"jerry@gmail.com", hashedPassword: bcrypt.hashSync("godDamnitJerry")},
      {username:"partyWithOSHA", email:"osha@gmail.com", hashedPassword: bcrypt.hashSync("regulations247")},
      {username:"catInTheHood", email:"cat@gmail.com", hashedPassword: bcrypt.hashSync("redFishBlueFish")},
